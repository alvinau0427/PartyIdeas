...
<?php
	...
	echo "<a href='calendar-index.php?month=". $change_month ."&year=". $change_year ."'><div class='previous'> Prev </div></a>";
	echo "<a href='calendar-index.php?month=". $change_month_next ."&year=". $change_year_next ."'><div class='next'> Next </div></a>";
...
for($i=1; $i<= $day_count; $i++):
	...
	echo "<a href='day_view.php?day=$i&month=$month&year=$year' title='$i $month_name' rel='day_view' target='_new'>";
...
if ( ($first_day_of_week=='Monday' && $last_day != 7) || ($first_day_of_week=='Sunday' && $last_day != 1) ) :
	...
	for($i=1; $i<=$first_day; $i++): 
		...
		echo "<a href='day_view.php?day=$i&month=$change_month_next&year=$change_year_next' title='$i $month_name' rel='day_view' target='_new'>";

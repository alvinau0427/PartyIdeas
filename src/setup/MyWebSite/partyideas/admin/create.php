<?php include_once( 'header.php' );
	include_once( 'libs/add_event.php' );
?>
	...
	<div id="calendar_wrap">
		<div class="title_bar">
			<div class="create_one">
				...
				<a href="../calendar-index.php" title="See Calendar" class="uibutton icon add">See Calendar</a>
			...
			<form method="post" action="create.php">
				<div class="form">
					...
					<div class="section">
						...
						<div>
							<input type="text" name="from_time" id="from_time" value="<?php if(isset($from_time)) { echo $_POST['from_time']; } ?>"/>
						</div>
					</div>
					...
					<div class="section">
						...
						<div>
							<input type="text" name="to_time" id="to_time" value="<?php if(isset($to_time)) { echo $_POST['to_time']; } ?>"/>
						</div>
					</div>

					<div class="section last">
						<div><input type="submit" name="add_event" value="Add Event" class="uibutton"/>
						</div>
					</div>

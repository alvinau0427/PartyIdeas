...
(function(i, ha, t, p) {
    var l = function(h) {
        function n(a, b) {
            ...
            a.aoColumns.push(b);
            if (a.aoPreSearchCols[d] === p || a.aoPreSearchCols[d] === null) a.aoPreSearchCols[d] = i.extend({}, l.models.oSearch);
            else {
        ...
        function q(a, b, c) {
            ...
            if (c !== p && c !== null) {
                ...
                i.extend(b, c);
                r(b, c, "sWidth", "sWidthOrig");
                if (c.iDataSort !== p) b.aDataSort = [c.iDataSort];
                r(b, c, "aDataSort")
            }
            b.fnGetData = ia(b.mDataProp);
            b.fnSetData = Ha(b.mDataProp);
            if (!a.oFeatures.bSort) b.bSortable = false;
            if (!b.bSortable || i.inArray("asc", b.asSorting) == -1 && i.inArray("desc", b.asSorting) ==
                -1) {
        ...
        function C(a) {
            for (var b =
                    0, c = 0; c < a.aoColumns.length; c++) a.aoColumns[c].bVisible === true && b++;
            return b
        }
        ...
        function S(a, b, c, d) {
            ...
            if (b)
                for (e = b.length - 1; e >= 0; e--) {
                    var k = b[e].aTargets;
                    i.isArray(k) || M(a, 1, "aTargets must be an array of targets, not a " + typeof k);
                    f = 0;
                    for (g = k.length; f < g; f++)
                        if (typeof k[f] === "number" && k[f] >= 0) {
                        ...
                        j = 0;
                        for (m = a.aoColumns.length; j < m; j++)
                            if (k[f] == "_all" || i(a.aoColumns[j].nTh).hasClass(k[f])) d(j, b[e])
                    }
                }
            if (c) {
                e = 0;
        ...
        function P(a,
            ...
            for (var f = a.aoColumns.length; d < f; d++) {
                c = a.aoColumns[d];
                typeof c.fnRender === "function" && c.bUseRendered && c.mDataProp !== null ? R(a, b, d, ba(a, b, d)) : R(a, b, d, E(a, b, d));
                if (c._bAutoType && c.sType != "string") {
                    e = E(a, b, d, "type");
                    if (e !== null && e !== "") {
                        e = D(e);
                        if (c.sType === null) c.sType = e;
                        else if (c.sType != e && c.sType != "html") c.sType = "string"
                    }
                }
            }
            a.aiDisplayMaster.push(b);
            a.oFeatures.bDeferRender ||
                qa(a, b);
            return b
        }

        function ja(a) {
            var b, c, d, e, f, g, j, m, k;
            if (a.bDeferLoading || a.sAjaxSource === null) {
                ...
                for (c = j.length; b < c; b++)
                    if (j[b].nodeName.toUpperCase() == "TR") {
                        m = a.aoData.length;
                        j[b]._DT_RowIndex = m;
                        a.aoData.push(i.extend(true, {}, l.models.oRow, {
                            nTr: j[b]
                        }));
                        a.aiDisplayMaster.push(m);
                        g = j[b].childNodes;
                        d = f = 0;
                        for (e = g.length; d < e; d++) {
                            k = g[d].nodeName.toUpperCase();
                            if (k == "TD" || k == "TH") {
                                R(a, m, f, i.trim(g[d].innerHTML));
                                f++
                            }
                        }
                    }
                ...
                if (f || m || y || !u) {
                    ...
                    for (c = a.aoData.length; b < c; b++) {
                        ...
                        if (f && k.sType != "string") {
                            ...
                            if (z !== "") {
                                z = D(z);
                                if (k.sType === null) k.sType = z;
                                else if (k.sType != z && k.sType != "html") k.sType = "string"
                            }
                        }
                        if (typeof k.mDataProp ===
                            "function") w.innerHTML = E(a, b, e, "display");
                        if (m) {
                            z = ba(a, b, e);
                            w.innerHTML = z;
                            k.bUseRendered && R(a, b, e, z)
                        }
                        if (y) w.className += " " + k.sClass;
                        if (u) d._anHidden[e] = null;
                        else {
                            d._anHidden[e] = w;
                            w.parentNode.removeChild(w)
                        }
                        k.fnCreatedCell && k.fnCreatedCell.call(a.oInstance, w, E(a, b, e, "display"), d._aData, b, e)
                    }
                }
            }
        ...
        function E(a, b, c, d) {
            ...
            if ((c = e.fnGetData(a.aoData[b]._aData, d)) === p) {
                if (a.iDrawError != a.iDraw && e.sDefaultContent === null) {
                    M(a, 0, "Requested unknown parameter " + (typeof e.mDataProp == "function" ? "{mDataprop function}" : "'" + e.mDataProp + "'") + " from the data source for row " + b);
                    a.iDrawError = a.iDraw
                }
                return e.sDefaultContent
            }
            if (c ===
                null && e.sDefaultContent !== null) c = e.sDefaultContent;
        ...
        function Ha(a) {
            if (a === null) return function() {};
                ...
                var b = a.split(".");
                return function(c, d) {
                    for (var e = 0, f = b.length - 1; e < f; e++) {
                        c = c[b[e]];
                        if (c === p) return
                    }
                    c[b[b.length - 1]] = d
        ...
        function Ia(a) {
            ...
            if (a.oFeatures.bSort)
                for (b = 0; b < a.aoColumns.length; b++) a.aoColumns[b].bSortable !==
                    false ? ua(a, a.aoColumns[b].nTh, b) : i(a.aoColumns[b].nTh).addClass(a.oClasses.sSortableNone);
        ...
        function ea(a, b, c) {
            ...
            for (e = b.length; d < e; d++) {
                ...
                g[d].nTr =
                    b[d].nTr;
                for (f = m - 1; f >= 0; f--) !a.aoColumns[f].bVisible && !c && g[d].splice(f, 1);
                j.push([])
            }
            d = 0;
            for (e = g.length; d < e; d++) {
                ...
                for (b = g[d].length; f < b; f++) {
                    ...
                    if (j[d][f] === p) {
                        ...
                        for (j[d][f] = 1; g[d + m] !== p && g[d][f].cell == g[d + m][f].cell;) {
                            j[d + m][f] = 1;
                            m++
                        }
                        for (; g[d][f + k] !== p && g[d][f].cell == g[d][f + k].cell;) {
                            for (c = 0; c < m; c++) j[d + c][f + k] = 1;
                            k++
                        }
                        g[d][f].cell.rowSpan = m;
        ...
        function H(a) {
            ...
            if (i.inArray(false, c) !== -1) O(a, false);
            else {
                a.bDrawing = true;
                ...
                if (a.aiDisplay.length !== 0) {
                    ...
                    for (g = g; g < c; g++) {
                        ...
                        if (f !== 0) {
                            ...
                            if (j._sRowStripe != k) {
                                i(m).removeClass(j._sRowStripe).addClass(k);
                                j._sRowStripe = k
                            }
                        }
                        L(a, "aoRowCallback", null, [m, a.aoData[a.aiDisplay[g]]._aData, e, g]);
                        d.push(m);
                        e++;
                        if (b !== 0)
                            for (j = 0; j < b; j++)
                                if (m == a.aoOpenRows[j].nParent) {
                    ...
                    if (a.asStripeClasses[0]) d[0].className =
                        a.asStripeClasses[0];
                    b = a.oLanguage;
                    f = b.sZeroRecords;
                    if (a.iDraw == 1 && a.sAjaxSource !== null && !a.oFeatures.bServerSide) f = b.sLoadingRecords;
                    else if (b.sEmptyTable && a.fnRecordsTotal() === 0) f = b.sEmptyTable;
                ...
                L(a, "aoHeaderCallback", "header", [i(a.nTHead).children("tr")[0], la(a), a._iDisplayStart, a.fnDisplayEnd(), a.aiDisplay]);
                L(a, "aoFooterCallback", "footer", [i(a.nTFoot).children("tr")[0],
                    la(a), a._iDisplayStart, a.fnDisplayEnd(), a.aiDisplay
                ]);
        ...
        function Ka(a) {
            ...
            for (var c = a.nTableWrapper, d = a.sDom.split(""), e, f, g, j, m, k, y, u = 0; u < d.length; u++) {
                f = 0;
                g = d[u];
                if (g == "<") {
                    j = i("<div></div>")[0];
                    ...
                    if (m == "'" || m == '"') {
                        ...
                        if (k.indexOf(".") != -1) {
                            m = k.split(".");
                            j.id = m[0].substr(1, m[0].length - 1);
                            j.className = m[1]
                        }
        ...
        function da(a, b) {
            b = i(b).children("tr");
            var c, d, e, f, g, j, m, k, y = function(z, Y, B) {
                for (; z[Y][B];) B++;
                return B
            };
            a.splice(0, a.length);
        ...
        function Sa(a, b) {
            ...
            b = ia(a.sAjaxDataProp)(b);
            for (var e = 0, f = b.length; e < f; e++)
                if (c) {
                    for (var g = [], j = 0, m = a.aoColumns.length; j < m; j++) g.push(b[e][d[j]]);
                    P(a, g)
                }
                else P(a, b[e]);
        ...
        function U(a, b, c) {
            ...
            if (a.oFeatures.bServerSide) f(b);
                ...
                Ta(a, b.sSearch, c, b.bRegex, b.bSmart, b.bCaseInsensitive);
                f(b);
                for (b = 0; b < a.aoPreSearchCols.length; b++) Ua(a, e[b].sSearch, b, e[b].bRegex, e[b].bSmart, e[b].bCaseInsensitive);
                Va(a)
            }
            a.bFiltered = true;
        ...
        function Va(a) {
            for (var b = l.ext.afnFiltering, c = 0, d = b.length; c < d; c++)
                for (var e = 0, f = 0, g = a.aiDisplay.length; f < g; f++) {
                    var j = a.aiDisplay[f - e];
                    if (!b[c](a, ka(a, j, "filter"), j)) {
        ...
        function Ua(a, b, c, d, e, f) {
            if (b !== "") {
                ...
                for (d = a.aiDisplay.length - 1; d >= 0; d--) {
                    e = za(E(a, a.aiDisplay[d], c, "filter"), a.aoColumns[c].sType);
                    if (!b.test(e)) {
        ...
        function xa(a, b) {
            if (!a.oFeatures.bServerSide) {
                ...
                for (var c = 0, d = b.length; c < d; c++) a.asDataSearch[c] = Aa(a, ka(a, b[c], "filter"))
            }
        }
        ...
        function Aa(a, b) {
            ...
            for (var d = a.__nTmpFilter, e = 0, f = a.aoColumns.length; e < f; e++)
                if (a.aoColumns[e].bSearchable) c += za(b[e], a.aoColumns[e].sType) + "  ";
            if (c.indexOf("&") !== -1) {
                d.innerHTML = c;
        ...
        function za(a, b) {
            if (typeof l.ext.ofnSearch[b] === "function") return l.ext.ofnSearch[b](a);
        ...
        function Wa(a) {
            if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                var b = a.oLanguage,
                    ...
                    g;
                g = f === 0 && f == e ? b.sInfoEmpty : f === 0 ? b.sInfoEmpty + " " + b.sInfoFiltered : f == e ? b.sInfo :
                    b.sInfo + " " + b.sInfoFiltered;
                g += b.sInfoPostFix;
                g = va(a, g);
        ...
        function va(a, b) {
            ...
            return b.replace("_START_", c).replace("_END_", d).replace("_TOTAL_",
                e).replace("_MAX_", f)
        }
        ...
        function oa(a) {
            ...
            if (a.bInitialised === false) setTimeout(function() {
                ...
                for (c = a.aoColumns.length; b < c; b++)
                    if (a.aoColumns[b].sWidth !== null) a.aoColumns[b].nTh.style.width = s(a.aoColumns[b].sWidth);
                ...
                if (a.sAjaxSource !==
                    ...
                    a.fnServerData.call(a.oInstance, a.sAjaxSource, c, function(e) {
                        var f = a.sAjaxDataProp !== "" ? ia(a.sAjaxDataProp)(e) : e;
                        for (b = 0; b < f.length; b++) P(a, f[b]);
        ...
        function Ca(a) {
            ...
            !a.sEmptyTable && a.sZeroRecords &&
                b.sEmptyTable === "No data available in table" && r(a, a, "sZeroRecords", "sEmptyTable");
        ...
        function Da(a, b) {
            ...
            else if (b == "first") a._iDisplayStart =
                0;
            else if (b == "previous") {
            ...
            else M(a, 0, "Unknown paging action: " +
                b);
        ...
        function O(a, b) {
            if (a.oFeatures.bProcessing)
                for (var c = a.aanFeatures.r, d = 0, e = c.length; d < e; d++) c[d].style.visibility = b ? "visible" : "hidden";
        ...
        function Oa(a) {
            ...
            if (d.length > 0) {
                d = d[0];
                if (d._captionSide === "top") j.appendChild(d);
                else d._captionSide === "bottom" && y && m.appendChild(d)
            }
            if (a.oScroll.sX !== "") {
        ...
        function Xa(a) {
            var b = a.nScrollHead.getElementsByTagName("div")[0],
                ...
                e, f, g, j, m, k, y, u, w = [],
                z = a.nTFoot !== null ? a.nScrollFoot.getElementsByTagName("div")[0] : null,
                Y = a.nTFoot !== null ? z.getElementsByTagName("table")[0] : null,
                B = i.browser.msie && i.browser.version <= 7;
            i(a.nTable).children("thead, tfoot").remove();
            g = i(a.nTHead).clone()[0];
            a.nTable.insertBefore(g, a.nTable.childNodes[0]);
            if (a.nTFoot !== null) {
                m = i(a.nTFoot).clone()[0];
                a.nTable.insertBefore(m, a.nTable.childNodes[1])
            }
            if (a.oScroll.sX === "") {
                d.style.width = "100%";
            ...
            if (a.oScroll.sX === "") {
                ...
                if (B && (i("tbody", d).height() > d.offsetHeight || i(d).css("overflow-y") == "scroll")) a.nTable.style.width = s(i(a.nTable).outerWidth() - a.oScroll.iBarWidth)
            }
            ...
            if (i(a.nTable).outerWidth() < e) {
                j = d.scrollHeight > d.offsetHeight || i(d).css("overflow-y") == "scroll" ? e + a.oScroll.iBarWidth :
                    e;
                if (B && (d.scrollHeight > d.offsetHeight || i(d).css("overflow-y") == "scroll")) a.nTable.style.width = s(j - a.oScroll.iBarWidth);
                d.style.width = s(j);
                b.parentNode.style.width = s(j);
                if (a.nTFoot !== null) z.parentNode.style.width = s(j);
                if (a.oScroll.sX === "") M(a, 1, "The table cannot fit into the current element which will cause column misalignment. The table has been drawn at its minimum possible width.");
                else a.oScroll.sXInner !== "" && M(a, 1, "The table cannot fit into the current element which will cause column misalignment. Increase the sScrollXInner value or remove it to allow automatic calculation")
            }
            else {
                d.style.width =
                    s("100%");
                b.parentNode.style.width = s("100%");
                if (a.nTFoot !== null) z.parentNode.style.width = s("100%")
            }
            if (a.oScroll.sY === "")
                if (B) d.style.height = s(a.nTable.offsetHeight + a.oScroll.iBarWidth);
            if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
                ...
                if (a.nTable.offsetHeight < d.offsetHeight) d.style.height = s(a.nTable.offsetHeight + B)
            }
            B = i(a.nTable).outerWidth();
            c.style.width = s(B);
            b.style.width = s(B);
            c = i(a.nTable).height() >
                d.clientHeight || i(d).css("overflow-y") == "scroll";
            b.style.paddingRight = c ? a.oScroll.iBarWidth + "px" : "0px";
            if (a.nTFoot !== null) {
                Y.style.width = s(B);
                z.style.width = s(B);
                z.style.paddingRight = c ? a.oScroll.iBarWidth + "px" : "0px"
            }
            i(d).scroll();
        ...
        function V(a, b, c) {
            for (var d = 0, e = b.length; d < e; d++)
                for (var f = 0, g = b[d].childNodes.length; f < g; f++)
                    if (b[d].childNodes[f].nodeType == 1) c ? a(b[d].childNodes[f], c[d].childNodes[f]) : a(b[d].childNodes[f])
        }
            ...
            for (f = 0; f < e; f++)
                if (a.aoColumns[f].bVisible) {
                    ...
                    if (a.aoColumns[f].sWidth !== null) {
                        c = Ya(a.aoColumns[f].sWidthOrig, a.nTable.parentNode);
                        if (c !== null) a.aoColumns[f].sWidth = s(c);
                        b++
                    }
                }
            if (e == g.length && b === 0 && d == e && a.oScroll.sX === "" && a.oScroll.sY === "")
                for (f =
                    0; f < a.aoColumns.length; f++) {
                    c = i(g[f]).width();
                    if (c !== null) a.aoColumns[f].sWidth = s(c)
                }
            else {
                ...
                for (f = d = 0; f < e; f++) {
                    var m = a.aoColumns[f];
                    if (m.bVisible && m.sWidthOrig !== null && m.sWidthOrig !== "") g[f - d].style.width = s(m.sWidthOrig);
                    else if (m.bVisible) g[f - d].style.width = "";
                    else d++
                }
                for (f = 0; f < e; f++)
                    if (a.aoColumns[f].bVisible) {
        ...
        function X(a, b) {
            var c, d, e, f, g, j, m = [],
                ...
                w = a.aoColumns,
                z = a.oLanguage.oAria;
            if (!a.oFeatures.bServerSide && (a.aaSorting.length !== 0 ||
                    a.aaSortingFixed !== null)) {
                m = a.aaSortingFixed !== null ? a.aaSortingFixed.concat(a.aaSorting) : a.aaSorting.slice();
                for (c = 0; c < m.length; c++) {
                    ...
                    if (l.ext.afnSortData[f]) {
                        ...
                        if (g.length === u.length) {
                            e = 0;
                            for (f = u.length; e < f; e++) R(a, e, d, g[e])
                        }
                        else M(a, 0, "Returned data sort array (col " + d + ") is the wrong length")
                    }
                }
                c = 0;
                ...
                for (d = u.length; c < d; c++)
                    for (e =
                        ...
                        for (j = B.length; g < j; g++) {
                            f = w[B[g]].sType;
                            f = y[(f ? f : "string") + "-pre"];
                            u[c]._aSortData[B[g]] = f ? f(E(a, c, B[g], "sort")) : E(a, c, B[g], "sort")
                        }
                    }
                a.aiDisplayMaster.sort(function(fa, I) {
                    var Q, Z, cb, $, ga;
                    for (Q = 0; Q < Y; Q++) {
                        ga = w[m[Q][0]].aDataSort;
                        Z = 0;
                        for (cb = ga.length; Z < cb; Z++) {
                            $ = w[ga[Z]].sType;
                            $ = y[($ ? $ : "string") + "-" + m[Q][1]](u[fa]._aSortData[ga[Z]], u[I]._aSortData[ga[Z]]);
                            if ($ !== 0) return $
                        }
                    }
            ...
            for (d = a.aoColumns.length; c < d; c++) {
                e = w[c].sTitle.replace(/<.*?>/g, "");
                b = w[c].nTh;
                b.removeAttribute("aria-sort");
                b.removeAttribute("aria-label");
                if (w[c].bSortable)
                    if (m.length > 0 && m[0][0] == c) {
                        b.setAttribute("aria-sort", m[0][1] == "asc" ? "ascending" : "descending");
                        b.setAttribute("aria-label", e + ((w[c].asSorting[m[0][2] + 1] ? w[c].asSorting[m[0][2] + 1] : w[c].asSorting[0]) == "asc" ? z.sSortAscending : z.sSortDescending))
                    }
                    else b.setAttribute("aria-label", e + (w[c].asSorting[0] == "asc" ? z.sSortAscending : z.sSortDescending));
            ...
            db(b, {}, function(e) {
                if (a.aoColumns[c].bSortable !== false) {
                    var f = function() {
                        var g, j;
                        if (e.shiftKey) {
                            for (var m = false, k = 0; k < a.aaSorting.length; k++)
        ...
        function aa(a) {
            ...
            if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
                d = T(a);
                if (a.oFeatures.bDeferRender) i(d).removeClass(f +
                    "1 " + f + "2 " + f + "3");
                else if (d.length >= g)
                    for (b = 0; b < g; b++)
                        if (d[b].className.indexOf(f + "1") != -1) {
                            c = 0;
                ...
                for (b = 0; b < e.length; b++) {
                    m = parseInt(e[b][0],
                        10);
                    c = 0;
                    for (a = d.length / g; c < a; c++) d[g * c + m].className += " " + f + j;
                    j < 3 && j++
                }
            }
        }
        ...
        function jb(a, b, c, d, e) {
            ...
            e = "";
            f = 9999999999999;
            if ((fb(a) !== null ? t.cookie.length : b.length + t.cookie.length) + 10 > 4096) {
                a = t.cookie.split(";");
            ...
            for (e = e; e < m; e++) {
                ...
                if (j.nTr !== null) {
                    ...
                    for (g = a.aoColumns.length; f < g; f++)
                        if (a.aoColumns[f].bVisible) c.push(b[f - d]);
                        else {
        ...
        function M(a, b, c) {
            ...
            else ha.console && console.log && console.log(a)
        }
        ...
        function gb(a, b) {
            for (var c in b)
                if (b.hasOwnProperty(c))
                    if (typeof h[c] === "object" && i.isArray(b[c]) === false) i.extend(true, a[c], b[c]);
                    else a[c] = b[c];
            return a
        }
        ...
        function hb(a) {
            return function() {
                var b = [A(this[l.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
                return l.ext.oApi[a].apply(this, b)
            }
        }
        var ib = ha.JSON ? JSON.stringify : function(a) {
            var b = typeof a;
            if (b !== "object" || a === null) {
                if (b === "string") a = '"' + a + '"';
                return a + ""
            ...
            for (c in a) {
                ...
                if (b === "string") d =
                    '"' + d + '"';
                else if (b === "object" && d !== null) d = ib(d);
                e.push((f ? "" : '"' + c + '":') + d)
            }
            return (f ? "[" : "{") + e + (f ? "]" : "}")
        };
        this.$ = function(a, b) {
            ...
            else M(e, 1, "Unknown selection options");
            e = i(d);
            d = e.filter(a);
            a = e.find(a);
        ...
        this.fnAdjustColumnSizing = function(a) {
            var b = A(this[l.ext.iApiIndex]);
            o(b);
            if (a === p || a) this.fnDraw(false);
            else if (b.oScroll.sX !==
        ...
        this.fnClose = function(a) {
            for (var b = A(this[l.ext.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++)
        ...
        this.fnDeleteRow = function(a, b, c) {
            var d = A(this[l.ext.iApiIndex]),
                e, f;
            a = typeof a === "object" ? N(d, a) : a;
            var g = d.aoData.splice(a, 1);
            e = 0;
            for (f = d.aoData.length; e < f; e++)
                if (d.aoData[e].nTr !== null) d.aoData[e].nTr._DT_RowIndex = e;
        ...
        this.fnDestroy = function(a) {
            ...
            b.bDestroying =
                true;
            L(b, "aoDestroyCallback", "destroy", [b]);
            e = 0;
            ...
            if (!a && b.nTableReinsertBefore) c.insertBefore(b.nTable,
                b.nTableReinsertBefore);
        ...
        this.fnIsOpen = function(a) {
            for (var b = A(this[l.ext.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++)
                if (b.aoOpenRows[c].nParent == a) return true;
            return false
        };
            ...
            if (g[a].bVisible != b) {
                if (b) {
                    ...
                    for (f = j.length; e < f; e++)
                        if (j[e].nTr !== null) k ? j[e].nTr.appendChild(j[e]._anHidden[a]) :
                ...
                e = 0;
                for (f = d.aoOpenRows.length; e < f; e++) d.aoOpenRows[e].nTr.colSpan = C(d);
                if (c === p || c) {
                    o(d);
                    H(d)
                }
        ...
        this.fnUpdate = function(a, b, c, d, e) {
            var f = A(this[l.ext.iApiIndex]);
            b = typeof b === "object" ? N(f, b) : b;
        ...
        this.oApi = {
            ...
            _fnReDraw: na,
            _fnAjaxUpdate: Ja,
            _fnAjaxParameters: Ra,
            _fnAjaxUpdateDraw: Sa,
            _fnServerParams: wa,
            _fnAddOptionsHtml: Ka,
            _fnFeatureHtmlTable: Oa,
            _fnScrollDraw: Xa,
            _fnAdjustColumnSizing: o,
            _fnFeatureHtmlFilter: Ma,
            _fnFilterComplete: U,
            _fnFilterCustom: Va,
            _fnFilterColumn: Ua,
            _fnFilter: Ta,
            _fnBuildSearchArray: xa,
            _fnBuildSearchRow: Aa,
            _fnFilterCreateSearch: ya,
            _fnDataToSearch: za,
            _fnSort: X,
            _fnSortAttachListener: ua,
            _fnSortingClasses: aa,
            _fnFeatureHtmlPaginate: Qa,
            _fnPageChange: Da,
            _fnFeatureHtmlInfo: Pa,
            _fnUpdateInfo: Wa,
            _fnFeatureHtmlLength: La,
            _fnFeatureHtmlProcessing: Na,
            _fnProcessingDisplay: O,
            _fnVisibleToColumnIndex: v,
            _fnColumnIndexToVisible: x,
            _fnNodeToDataIndex: N,
            _fnVisbleColumns: C,
            _fnCalculateEnd: J,
            _fnConvertToWidth: Ya,
            _fnCalculateColumnWidths: pa,
            _fnScrollingWidthAdjust: $a,
            _fnGetWidestNode: Za,
            _fnGetMaxLenString: ab,
            _fnStringToCss: s,
            _fnDetectType: D,
            _fnSettingsFromNode: A,
            _fnGetDataMaster: la,
            _fnGetTrNodes: ca,
            _fnGetTdNodes: T,
            _fnEscapeRegex: Ba,
        ...
        return this.each(function() {
            ...
            var e = false,
                f = false;
            if (this.nodeName.toLowerCase() != "table") M(null, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
            else {
                a = 0;
                for (b = l.settings.length; a < b; a++) {
                    if (l.settings[a].nTable == this)
                        if (h === p || h.bRetrieve) return l.settings[a].oInstance;
                        else if (h.bDestroy) {
                ...
                l.settings.push(g);
                g.oInstance = Ga.length === 1 ? Ga : i(this).dataTable();
                h || (h = {});
                h.oLanguage && Ca(h.oLanguage);
                h = gb(i.extend(true, {}, l.defaults), h);
                ...
                if (g.oScroll.sX !== "" || g.oScroll.sY !== "") g.oScroll.iBarWidth = bb();
                ...
                if (h.bStateSave) {
                    ...
                    eb(g, h);
                    K(g, "aoDrawCallback", Ea, "state_save")
                }
                ...
                if (h.oLanguage.sUrl !== "") {
                    ...
                    i.getJSON(g.oLanguage.sUrl, null, function(m) {
                        Ca(m);
                        i.extend(true, g.oLanguage, h.oLanguage, m);
                        oa(g)
                    });
                    e = true
                }
                ...
                a = 0;
                for (b = g.asStripeClasses.length; a < b; a++)
                    if (d.filter(":lt(2)").hasClass(g.asStripeClasses[a])) {
                        c = true;
                        break
                    }
                if (c) {
                    g.asDestroyStripes = ["", ""];
                    if (i(d[0]).hasClass(g.oClasses.sStripeOdd)) g.asDestroyStripes[0] +=
                ...
                S(g, h.aoColumnDefs, d, function(m, k) {
                    q(g, m, k)
                });
                a = 0;
                ...
                if (b.length === 0) {
                    b = [t.createElement("thead")];
                    this.appendChild(b[0])
                }
                g.nTHead = b[0];
                b = i(this).children("tbody");
                if (b.length === 0) {
                    b = [t.createElement("tbody")];
                    this.appendChild(b[0])
                }
                g.nTBody = b[0];
                ...
                if (f)
                    for (a = 0; a < h.aaData.length; a++) P(g, h.aaData[a]);
                else ja(g);
    ...
    l.fnIsDataTable = function(h) {
        for (var n = l.settings, q = 0; q < n.length; q++)
            if (n[q].nTable === h || n[q].nScrollHead === h || n[q].nScrollFoot === h) return true;
        return false
    };
    ...
    l.defaults = {
        ...
        fnServerData: function(h, n, q, o) {
            o.jqXHR = i.ajax({
                ...
                error: function(v, x) {
                    x == "parsererror" && o.oApi._fnLog(o, 0, "DataTables warning: JSON data from server could not be parsed. This is caused by a JSON formatting error.")
                }
            })
        },
        fnServerParams: null,
    ...
    i.extend(l.ext.oPagination, {
        two_button: {
            fnInit: function(h, n, q) {
                var o = h.oLanguage.oPaginate,
                    v = function(C) {
                        h.oApi._fnPageChange(h, C.data.action) && q(h)
                    };
                o = !h.bJUI ? '<a class="' + h.oClasses.sPagePrevDisabled + '" tabindex="' + h.iTabIndex + '" role="button">' + o.sPrevious + '</a><a class="' + h.oClasses.sPageNextDisabled + '" tabindex="' + h.iTabIndex + '" role="button">' + o.sNext + "</a>" :
                    '<a class="' + h.oClasses.sPagePrevDisabled + '" tabindex="' + h.iTabIndex + '" role="button"><span class="' + h.oClasses.sPageJUIPrev + '"></span></a><a class="' + h.oClasses.sPageNextDisabled + '" tabindex="' + h.iTabIndex + '" role="button"><span class="' + h.oClasses.sPageJUINext + '"></span></a>';
                i(n).append(o);
                var x = i("a", n);
                o = x[0];
                x = x[1];
            ...
            fnUpdate: function(h) {
                if (h.aanFeatures.p)
                    for (var n = h.oClasses, q = h.aanFeatures.p, o = 0, v = q.length; o < v; o++)
                        if (q[o].childNodes.length !== 0) {
                            q[o].childNodes[0].className = h._iDisplayStart === 0 ? n.sPagePrevDisabled : n.sPagePrevEnabled;
                            q[o].childNodes[1].className = h.fnDisplayEnd() == h.fnRecordsDisplay() ? n.sPageNextDisabled : n.sPageNextEnabled
                        }
            }
        },
        ...
        full_numbers: {
            fnInit: function(h, n, q) {
                ...
                i(n).append('<a  tabindex="' + h.iTabIndex + '" class="' + v.sPageButton + " " + v.sPageFirst + '">' + o.sFirst + '</a><a  tabindex="' + h.iTabIndex + '" class="' + v.sPageButton + " " + v.sPagePrevious + '">' + o.sPrevious + '</a><span></span><a tabindex="' + h.iTabIndex + '" class="' + v.sPageButton + " " + v.sPageNext + '">' + o.sNext + '</a><a tabindex="' + h.iTabIndex + '" class="' + v.sPageButton + " " + v.sPageLast + '">' + o.sLast + "</a>");
                var C = i("a", n);
                o = C[0];
                v = C[1];
                var D = C[2];
                ...
                if (!h.aanFeatures.p) {
                    ...
                    C.id = h.sTableId + "_last"
                }
            },
            fnUpdate: function(h, n) {
                if (h.aanFeatures.p) {
                    var q = l.ext.oPagination.iFullNumbersShowPages,
                        o = Math.floor(q / 2),
                        v = Math.ceil(h.fnRecordsDisplay() / h._iDisplayLength),
                        x = Math.ceil(h._iDisplayStart /
                            h._iDisplayLength) + 1,
                        C = "",
                        D, G = h.oClasses,
                        F, S = h.aanFeatures.p,
                        P = function(ja) {
                            h.oApi._fnBindAction(this, {
                                ...
                                h.oApi._fnPageChange(h, N.data.page);
                                n(h);
                                N.preventDefault()
                            })
                        };
                    if (h._iDisplayLength === -1) x = o = D = 1;
                    else if (v < q) {
                        D = 1;
                        o = v
                    }
                    ...
                    for (q = D; q <= o; q++) C += x !== q ? '<a tabindex="' + h.iTabIndex + '" class="' + G.sPageButton + '">' + h.fnFormatNumber(q) + "</a>" : '<a tabindex="' + h.iTabIndex + '" class="' + G.sPageButtonActive +
                        '">' + h.fnFormatNumber(q) + "</a>";
                    q = 0;
                    for (o = S.length; q < o; q++)
                        if (S[q].childNodes.length !== 0) {
                            i("span:eq(0)", S[q]).html(C).children("a").each(P);
                            F = S[q].getElementsByTagName("a");
                            ...
                            i([F[2], F[3]]).addClass(v === 0 || x === v || h._iDisplayLength === -1 ? G.sPageButtonStaticDisabled : G.sPageButton)
                        }
                }
            }
        }

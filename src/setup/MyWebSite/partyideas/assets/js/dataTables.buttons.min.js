...
! function(a) {
    ...
    a.extend(i.prototype, {
        ...
        destroy: function() {
            ...
            var b, c, d, e, f = this.s.buttons,
                g = this.s.subButtons;
            for (b = 0, c = f.length; c > b; b++)
                for (this.removePrep(b), d = 0, e = g[b].length; e > d; d++) this.removePrep(b + "-" + d);
        ...
        removeCommit: function() {
            var a, b, c, d = this.s.buttons,
                e = this.s.subButtons;
            for (a = d.length - 1; a >= 0; a--) null === d[a] && (d.splice(a, 1), e.splice(a, 1), this.c.buttons.splice(a, 1));
            for (a = 0, b = e.length; b > a; a++)
                for (c = e[a].length - 1; c >= 0; c--) null === e[a][c] && (e[a].splice(c, 1), this.c.buttons[a].buttons.splice(c, 1));
            return this
        },
        ...
        toIndex: function(a) {
            var b, c, d, e, f = this.s.buttons,
                g = this.s.subButtons;
            for (b = 0, c = f.length; c > b; b++)
                if (f[b].node[0] === a) return b + "";
            for (b = 0, c = g.length; c > b; b++)
                for (d = 0, e = g[b].length; e > d; d++)
        ...
        _constructor: function() {
            ...
            e._buttons || (e._buttons = []), e._buttons.push({
                inst: this,
                name: this.c.name
            }), this._buildButtons(this.c.buttons), d.on("destroy", function() {
                b.destroy()
            }), a("body").on("keyup." + this.s.namespace, function(a) {
                if (!c.activeElement || c.activeElement === c.body) {
                    var d = String.fromCharCode(a.keyCode).toLowerCase(); - 1 !== b.s.listenKeys.toLowerCase().indexOf(d) && b._keypress(d, a)
                }
            })
        },
        _addKey: function(b) {
            ...
            for (var h = 0, i = b.length; i > h; h++) {
                ...
                if (j)
                    if (a.isArray(j)) this._buildButtons(j, c, e);
                        ...
                        if (k) {
                            var l = k.node;
                            if (c.append(k.inserter), e === d ? (this.s.buttons.push({
                                    node: l,
                                    conf: j,
                                    inserter: k.inserter
                                }), this.s.subButtons.push([])) : this.s.subButtons[e].push({
                                    node: l,
                                    conf: j,
                                    inserter: k.inserter
                                }), j.buttons) {
        ...
        _buildButton: function(b, c) {
            ...
            e.tag ? k.append(a("<" + e.tag + "/>").html(i(b.text)).addClass(e.className)) : k.html(i(b.text)), b.enabled === !1 && k.addClass(d.disabled), b.className && k.addClass(b.className), b.titleAttr && k.attr("title", b.titleAttr), b.namespace || (b.namespace = ".dt-button-" + g++);
            var l, m = this.c.dom.buttonContainer;
            return l = m && m.tag ? a("<" + m.tag + "/>").addClass(m.className).append(k) : k, this._addKey(b), {
                node: k,
                inserter: l
            }
        },
        ...
        _keypress: function(b, c) {
            ...
            for (d = 0, e = i.length; e > d; d++)
                for (f = 0, g = i[d].length; g > f; f++) j(i[d][f].conf, i[d][f].node)
        },
        ...
        var d = [],
            ...
            f = function(b) {
                if (a.isArray(b))
                    for (var g = 0, h = b.length; h > g; g++) f(b[g]);
                else if ("string" == typeof b)
                    if (-1 !== b.indexOf(",")) f(b.split(","));
                    else {
                        var i = a.inArray(a.trim(b), e); - 1 !== i && d.push(c[i].inst)
                    }
                else "number" == typeof b && d.push(c[b].inst)
            };
        return f(b), d
    }, i.buttonSelector = function(b, c) {
        for (var e = [], f = function(b, c) {
                var g, h, i = [];
                ...
                if (a.isArray(b) || b instanceof a)
                    for (g = 0, h = b.length; h > g; g++) f(b[g], c);
                else if (null === b || b === d || "*" === b)
                    for (g = 0, h = i.length; h > g; g++) e.push({
                        inst: c,
                        idx: c.toIndex(i[g].node)
                    });
                    ...
                    else if (b.match(/^\d+(\-\d+)?$/)) e.push({
                    inst: c,
                    idx: b
                });
                else if (-1 !== b.indexOf(":name")) {
                    var l = b.replace(":name", "");
                    for (g = 0, h = i.length; h > g; g++) i[g].name === l && e.push({
                        inst: c,
                        idx: c.toIndex(i[g].node)
                    })
                }
                else a(j).filter(b).each(function() {
                    e.push({
                        inst: c,
                        idx: c.toIndex(this)
                    })
                    ...
                    var m = a.inArray(b, j); - 1 !== m && e.push({
                        inst: c,
                        idx: c.toIndex(j[m])
                    })
                }
        ...
        collection: {
            ...
            action: function(d, e, f, g) {
                var h = f,
                    ...
                    l = !1;
                a("div.dt-button-background").length && (l = a("div.dt-button-collection").offset(), a(c).trigger("click.dtb-collection")), g._collection.addClass(g.collectionLayout).css("display", "none").appendTo("body").fadeIn(g.fade);
                var m = g._collection.css("position");
                if (l && "absolute" === m) g._collection.css({
                    top: l.top + 5,
                    left: l.left + 5
                });
                else if ("absolute" === m) {
                    g._collection.css({
                        top: j.top + h.outerHeight(),
                        left: j.left
                    });
                ...
                g.background && i.background(!0, g.backgroundClassName, g.fade), setTimeout(function() {
                    a("div.dt-button-background").on("click.dtb-collection", function() {}), a("body").on("click.dtb-collection", function(b) {
                        a(b.target).parents().andSelf().filter(g._collection).length || (g._collection.fadeOut(g.fade, function() {
                            g._collection.detach()
                        }), a("div.dt-button-background").off("click.dtb-collection"), i.background(!1, g.backgroundClassName, g.fade), a("body").off("click.dtb-collection"), e.off("buttons-action.b-internal"))
                    })
                }, 10), g.autoClose && e.on("buttons-action.b-internal", function() {
        ...
        return b === d && (b = a, a = d), this.iterator(!0, "table", function(c) {
    ...
    e.Api.register("buttons.info()", function(b, c, e) {
        var f = this;
        return b === !1 ? (a("#datatables_buttons_info").fadeOut(function() {
            a(this).remove()
        }), clearTimeout(j), j = null, this) : (j && clearTimeout(j), a("#datatables_buttons_info").length && a("#datatables_buttons_info").remove(), b = b ? "<h2>" + b + "</h2>" : "", a('<div id="datatables_buttons_info" class="dt-button-info"/>').html(b).append(a("<div/>")["string" == typeof c ? "html" : "append"](c)).css("display", "none").appendTo("body").fadeIn(), e !== d && 0 !== e && (j = setTimeout(function() {
            f.buttons.info(!1)
        }, e)), this)
    ...
    var k = a("<textarea/>")[0],
        l = function(b, c) {
            for (var d = a.extend(!0, {}, {
                ...
                }, f = b.columns(d.columns).indexes().map(function(a, c) {
                    return d.format.header(b.column(a).header().innerHTML, a)
                }).toArray(), g = b.table().footer() ? b.columns(d.columns).indexes().map(function(a, c) {
                    var e = b.column(a).footer();
                    return d.format.footer(e ? e.innerHTML : "", a)
                }).toArray() : null, h = b.rows(d.rows, d.modifier).indexes().toArray(), i = b.cells(h, d.columns).render(d.orthogonal).toArray(), j = f.length, l = j > 0 ? i.length / j : 0, m = new Array(l), n = 0, o = 0, p = l; p > o; o++) {
    ...
    return a.fn.dataTable.Buttons = i, a.fn.DataTable.Buttons = i, a(c).on("init.dt plugin-init.dt", function(a, b, c) {
        if ("dt" === a.namespace) {

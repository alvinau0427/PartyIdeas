...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    // If you only require simple custmisation then you can use @link #setSelectedIndicatorColors(int...)} to achieve similar effects.
    ...
    //Set the {@link ViewPager.OnPageChangeListener}. When using {@link SlidingTabLayout} you are required to set any {@link ViewPager.
    // OnPageChangeListener} through this method. This is so that the layout can update it's scroll position correctly. @see ViewPager#setOnPageChangeListener(ViewPager.OnPageChangeListener)
